...
export const root = window, html = document.documentElement, body = document.body, main = body.querySelector("main"), header = body.querySelector("header"), footer = body.querySelector("footer"), canvas = body.insertBefore(renderer.domElement, body.firstElementChild);
